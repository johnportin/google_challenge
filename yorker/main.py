# The entirety of the Edmonds Blossom algorithm was made
# possible thanks to: https://github.com/yorkyer/edmonds-blossom
# of which I copy and pasted
    ...
    def __str__(self):
        ...
        for u in self.nodes:
            if u in visited:
                ...
                result += str(u) + " --> " + str(u.mate) + "\n"
                visited.append(u)
                visited.append(u.mate)
                # result += str(u) + "\n"
                # print(self.nodes[u])
        return result
...
def solution(l):
    ...
    nodes = [Node() for i in range(len(adj))]
    ...
    print(match)
    return match.remaining_matchings()
    
    
# l = [i for i in range(1, 10)]
l = [random.randint(1, max) for i in range(100)]
# l = [1, 2, 1, 2, 1, 2]
print(l)
print(solution(l))
